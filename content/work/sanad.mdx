...
<DeviceFrame
  ...
  caption="The actual working prototype, not a video. Reach the rejection path by simulating that outcome on the pending screen. This is the post-audit v2 build. Prefer to skim? The key screens are captured below."
>
  <SanadPrototype />
</DeviceFrame>
