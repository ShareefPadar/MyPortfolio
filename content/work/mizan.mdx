...
<Summary
  readTime="9 min"
  problem="Business accounts get frozen for compliance reviews with no stage, no clock, and a rolling promise of another 24 hours, while the linked POS stops settling."
  approach="Designed and built six screens for the wait itself: a stage tracker, a running clock, a proactive admission when the estimate slips, and a scoped restriction that keeps the business trading."
  constraint="The freeze is often mandatory and the reason legally cannot be disclosed. Only the communication layer was ever mine to change."
/>
