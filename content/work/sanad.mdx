...
<Summary
  readTime="10 min"
  problem="New businesses cannot move money until they pass KYB verification, so they start it, hit friction, and quit. I hit this same wall myself going through Companies House."
  approach="Designed the full six-screen verification flow for a concept business bank, built it as a working React prototype, then audited my own build and published what it got wrong."
  constraint="Regulators require every step, so removing friction was off the table. The process had to feel faster without becoming any less rigorous."
/>
