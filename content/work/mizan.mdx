...
<Shot src="/assets/work/mizan-tracker.png" alt="Concept UI, not any real bank's interface: a four-stage review tracker showing the current stage, who owns it, and when it last moved" caption="The four-stage tracker: current stage, who holds it, and when it last moved." />
...
<Shot src="/assets/work/mizan-clock.png" alt="Concept UI, not any real bank's interface: a persistent strip showing elapsed working days against the stated maximum" caption="The day counter is persistent, appearing on every screen rather than buried in a status page." />
...
<Shot src="/assets/work/mizan-slipped.png" alt="Concept UI, not any real bank's interface: an alert showing the passed estimate, a revised range, a named accountable officer, and an escalation date" caption="The slipped state: passed estimate acknowledged, revised range, named officer, escalation date." />
...
<Shot src="/assets/work/mizan-paused.png" alt="Concept UI, not any real bank's interface: a paused state reading 'waiting on documents from you, not from us', with the estimate showing as paused" caption="The paused state names the customer as the blocker and stops the clock rather than pretending progress." />
...
<Shot src="/assets/work/mizan-log.png" alt="Concept UI, not any real bank's interface: a dated activity log with entries and a closing line explaining that calling will not reveal more than the page shows" caption="A dated log, including the days where the honest entry is that nothing moved." />
