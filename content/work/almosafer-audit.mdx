...
<BeforeAfter
  ...
  caption="Before: primary services repeated across the nav, hero tabs, and icon row. After: consolidated into a single search widget, niche services grouped under Travel Essentials."
  aspect="aspect-[3/2]"
/>
...
<BeforeAfter
  before="/assets/work/almosafer-room-before.png"
  after="/assets/work/almosafer-room-after.png"
  caption="Before: 'Show rooms' and 'Select' in the same high-saturation red. After: 'Select' stays solid red as the primary CTA, 'Show rooms' becomes a ghost button."
  aspect="aspect-[9/16]"
/>
