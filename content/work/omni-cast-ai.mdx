...
<Summary
  readTime="4 min"
  problem="Marketers switch between four tools to run one campaign, guess at posting times, and only find out what worked after publishing."
  approach="Designed a publishing assistant with a prediction behind every step: inline AI suggestions, predictive scheduling, and a calendar that re-scores as campaigns run."
  constraint="People wanted AI help but not a black box. Every suggestion had to show its reasoning and stay overridable, or trust collapsed."
/>
